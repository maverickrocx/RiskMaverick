...
reviewed: 2026-07-30
benchmarks:
  - { name: "SOFR", key: "sofr", region: "US · NY Fed", price: "3.66%", unit: "o/n", asof: "3 Sep 2026", source: "NY Fed" }
  - { name: "€STR", key: "estr", region: "EU · ECB", price: "2.189%", unit: "o/n", asof: "4 Sep 2026", source: "ECB" }
  - { name: "Fed funds target", key: "fed_target", region: "US · FOMC", price: "3.50–3.75%", unit: "range", asof: "7 Sep 2026", source: "Federal Reserve" }
benchmark_note: "Overnight benchmarks published daily by the New York Fed and the ECB, alongside the FOMC’s current target range. SOFR prints inside that range; €STR tracks the ECB’s policy corridor."
key_benchmarks:
